...
LDFLAGS = --gc-sections
FLAGS = -mcpu=cortex-m4 -O0 -mfloat-abi=hard -march=armv7e-m+fp
...
All:
	...
	arm-none-eabi-ld -T $(LDFILE) $(LDFLAGS) -o $(BUILD_DIR)/proj_name.elf $(BUILD_DIR)/main.o $(BUILD_DIR)/gcc_startup_nrf52840.o $(BUILD_DIR)/croutine.o $(BUILD_DIR)/event_groups.o $(BUILD_DIR)/heap_1.o $(BUILD_DIR)/list.o $(BUILD_DIR)/queue.o $(BUILD_DIR)/tasks.o $(BUILD_DIR)/timers.o $(BUILD_DIR)/port.o
